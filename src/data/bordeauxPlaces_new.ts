...
export const bordeauxMicroPlaces: BordeauxMicroPlace[] = [
  {
    ...
    greenCalm: 5.4,
    confidence: "medium",
    evidenceNote: "Adjacent official IRIS polygons (medium confidence).",
  },
  {
  ...
  },
  {
    ...
    greenCalm: 4.8,
    confidence: "medium",
    evidenceNote: "Capucins-Victoire IRIS 5–8 grouped; Saint-Michel nightlife and market axis spans IRIS edges (medium confidence).",
  },
  {
  ...
  },
  {
    ...
    greenCalm: 8.0,
    confidence: "medium",
    evidenceNote: "Saint-Seurin-Fondaudège IRIS merge; Jardin Public label wider than the official IRIS footprint (medium confidence).",
  },
  {
    ...
    greenCalm: 6.8,
    confidence: "medium",
    evidenceNote: "Chartrons-Grand Parc IRIS 5–12 span Grand Parc and Ravezies; peri-campus student fringe relabelled (medium confidence).",
  },
  {
  ...
  },
  {
    ...
    greenCalm: 7.2,
    confidence: "low",
    evidenceNote: "Single Chartrons-Grand Parc 13 IRIS polygon; Aubiers/Le Lac label broader than geometry (low confidence).",
  },
  {
  ...
  },
  {
    ...
    greenCalm: 6.2,
    confidence: "low",
    evidenceNote: "Single La Bastide 3 IRIS polygon; Bastide-Niel/Brazza/Darwin micro label approximate (low confidence).",
  },
  {
    ...
    greenCalm: 6.6,
    confidence: "medium",
    evidenceNote: "La Bastide 4–5 IRIS merge; Benauge/Galin residential east-bank label (medium confidence).",
  },
  {
  ...
  },
  {
    ...
    greenCalm: 7.4,
    confidence: "medium",
    evidenceNote: "Villa Primerose Parc Bordelais-Caudéran IRIS 1–3 split; Caudéran micro labels span official IRIS families (medium confidence).",
  },
  {
    ...
    greenCalm: 8.6,
    confidence: "medium",
    evidenceNote: "Villa Primerose / Lestonnat-Monséjour IRIS merge; park-adjacent residential split from broader Caudéran labels (medium confidence).",
  },
  {
    ...
    greenCalm: 8.2,
    confidence: "medium",
    evidenceNote: "Lestonnat-Monséjour IRIS 5–9 grouped; western Caudéran micro label (medium confidence).",
  },
  {
    ...
    greenCalm: 6.4,
    confidence: "medium",
    evidenceNote: "Adjacent official Bordeaux Métropole sub-quartiers (medium confidence).",
  },
  {
    code: "talence-campus",
  ...
  },
  {
    ...
    greenCalm: 8.4,
    confidence: "medium",
    evidenceNote: "Score-only row for Gradignan sub-area rankings; not mapped as a separate polygon.",
    mapExcluded: true,
  },
  {
